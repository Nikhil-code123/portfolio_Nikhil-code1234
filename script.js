...
window.addEventListener('scroll', () => {
    ...
    prog.style.width = scrollPercent + '%';
        ...
        const words = ['AI/ML Developer','Java Programmer','Full Stack Developer','Flask Backend Developer','ML Engineer','Data Analyst','Problem Solver','Open Source Contributor'];
